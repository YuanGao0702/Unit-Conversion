...
public class ConvServer2 {
	...
	private static void start() throws UnknownHostException, IOException {
		...
		out.println("add $ oz 127.0.0.1 4444");
		for (int i = 0; i < 6; i++) {
			reader.readLine();
		}
		...
		out1.println("add $ oz 127.0.0.1 4444");
		for (int i = 0; i < 6; i++) {
			reader1.readLine();
		}
	...
	private static void end() throws UnknownHostException, IOException {
		...
		out.println("remove 127.0.0.1 4444");
		...
		out1.println("remove 127.0.0.1 4444");
